...
interface EigenVectorAnimationsContentProps {
...
export const EigenVectorAnimationsContent = ({
  value,
  animations,
  onAddClick,
  handleCheck,
}: EigenVectorAnimationsContentProps) => {
    ...
    return (
      <Flex direction="row" align="center" gap="3px">
        <CustomActionIcon
          ...
          onClick={() =>
            navigate(
              `/edit_animation/${animation?.id}?from=eigen_vector_animations`,
            )
          }
          withTooltip
          tooltipLabel="Edit"
